...
export const memories: Memory[] = [
  {
    ...
    photo: "/photos/Peggy_Pugh.jpg",
  },
  {
    name: "Marjorie Ornston",
    quote:
    ...
    photo: "/photos/marjorie_ornston.jpg",
  },
  {
    name: "Catherine Downey",
    quote:
      "Katherine has spent the last seven years consistently expanding my horizons and stimulating my mind in ways I never expected. Together, we've crossed borders — from the beauty of Alaska to the streets of London, Mexico, and Belgium — but the most significant journey has been the internal one.\n\nThrough her, I've discovered transformative art, a circle of incredible people, and a creative fire I never knew I possessed. She is more than a friend; she is a mentor who leads with boldness, creativity, and a delightful sense of whimsy. Most of all, I admire her bravery. Katherine, thank you for changing my world. I love you!",
    photo: "/photos/Catherine_Downey.jpg",
  },
  {
    name: "Patty Hsiu",
    quote:
      "Life is stressful and filled with anxiety. Taxes, traffic, what to have for dinner, what mess has the dog gotten into, Wordle, losing stuff, the state of the world, passwords, stains, awful kids, body aches\u2026 too many to mention, but it's all bearable, dare I say fun even, with Katherine.\n\n\u201cQueen LaDeeDa\u201d is not quite right to me as that implies pretentiousness or dismissiveness. There's definitely caring and processing and making things right whether it is ripping out substandard andamento, finding the perfect substrate, shaping bread, pulling together the perfect trip, or standing by clear values with no pretention. Our Queen of the Miraculous Journeys? Our Lady of Adventure? Queen of Creative Conundrums? Here's to many more experiences!\nxoxo",
    photo: "/photos/Patty_Hsiu.jpg",
  },
  {
  ...
  },
  {
    ...
    photo: "/photos/Lauralyn_Eschner.jpg",
  },
  {
    name: "Roe Weatherspoon",
    quote:
      "My first trip to England with the Englands. There would be two more. With each trip, there would be amazing people that I would meet who would become lifelong friends who would get me through difficult times, most especially Katherine.\n\nAs you can see from this lovely picture, Katherine is not in the picture because she's taking the picture where she climbed a wall to be high and unselfishly, she is not in the picture. With each trip, I learned amazing things, saw amazing art, saw amazing sites and got to spend time with an amazing woman. I love her sense of humor and how she takes no BS from anyone.",
    photo: "/photos/ROE_WEATHERSPOON.jpg",
  },
  {
    name: "Jane England",
    quote:
  ...
  },
  {
    ...
    photo: "/photos/Robin_McIndoo.jpg",
  },
  {
    name: "Kari-Nina Karlsen",
    quote:
      "I have so many memories of your mom, it is difficult\u2026\n\nThe first time I met you Katherine, was in 2005 at the Muck. You have since become one of the most influential people in my life. You opened the door to art, to a community of people who have become dear friends, to London, to Michael, to innumerable artists and more. I consider that day, in 2005, one of my fondest and life-altering memories.",
    photo: "/photos/Kari-Nina_Karlsen.png",
  },
  {
    name: "Rick Rinaldi",
    quote:
  ...
  },
  {
    ...
    photo: "/photos/Jim_and_Carol_Towler.jpg",
  },
  {
  ...
  },
  {
    ...
    photo: "/photos/VERA_LAWSON.jpg",
  },
  {
    name: "Sima Zeiger",
    quote:
      "Dear Katherine,\nI am so very grateful that you came into my life when you did during Covid with your wonderfully inspiring Zoom journaling workshops and amazing mosaic workshops. Thank you for all that you do. All the best in this new chapter of your life. Happy Birthday. I look forward to sharing many more artistic journeys.",
    photo: "/photos/Sima_Zeiger.png",
  },
  {
    name: "Emma Gourley",
    quote:
  ...
  },
  {
    ...
    quote: "",
    photo: "/photos/Candace_Magoski.jpg",
  },
];
